...
const string strMessageMagic = "CreCoin2 Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CreCoin2: 0.35 days
static const int64 nTargetSpacing = 120; // CreCoin2: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal CreCoin2 miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CreCoin2", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1514972531;//1366559428;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1514972531;//2085386442;
